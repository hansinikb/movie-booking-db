    ...
    Theatre updateTheatre(@RequestBody Theatre newTheatre, @PathVariable Long id) {
        return theatreRepository.findById(id)
                .map(theatre -> {
                    ...
                    theatre.setScreenList(newTheatre.getScreenList());
                    theatre.setFoodVendorList(newTheatre.getFoodVendorList());
                    theatre.setShowtimeList(newTheatre.getShowtimeList());
